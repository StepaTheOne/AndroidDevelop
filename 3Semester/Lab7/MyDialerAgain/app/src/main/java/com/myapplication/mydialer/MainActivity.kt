    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchEditText.addTextChangedListener {
            val filteredContacts = contacts.filter { item ->
                item.phone.lowercase().contains(it.toString().lowercase()) || item.name.lowercase().contains(it.toString().lowercase()) || item.type.lowercase().contains(it.toString().lowercase())
            }
